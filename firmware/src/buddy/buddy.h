...
class Arduino_GFX;
// Clawdmeter-specific: set the Arduino_GFX render target (typically an
// Arduino_Canvas backed by PSRAM, shared with an LVGL canvas widget).
void buddy_set_target(Arduino_GFX* tgt);
